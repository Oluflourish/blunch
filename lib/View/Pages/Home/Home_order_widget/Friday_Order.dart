...
class FridayOrder extends StatefulWidget {
  @override
  _FridayOrderState createState() => _FridayOrderState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: ListView.builder(
        itemCount: friday.dayfiveitem.length,
        //shop.daytwo.length,
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    (friday.dayfiveitem[i].price.toString()),
                                    style: TextStyle(
                                        fontSize: 14,
                                        fontFamily: 'Gordita',
                                        color: Color(0xff4F4F4F),
